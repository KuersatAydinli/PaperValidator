...
/**
  ...
  */
class SampleSizeExtractorTest_useless extends FunSuite{
...
//    val files = getListOfFiles(PdfPath)
//    var filesCount = 0
//    val finalEvaluationList = mutable.Map[String,mutable.Map[String,List[Int]]]
//    for(file <- files){
...
////    finalEvaluationList.foreach(paper => {
////
////    })
//    info("===== Recall OL1 =====")
//
...
//    info("===== Recall NL1 =====")
//
//    info("===== Presicion L2 - Exact Matches =====")
//
//    info("===== Presicion L2 - Exact Matches =====")
//
//    info("===== Presicion L2 - Partial Matches =====")
//
//    info("===== Presicion L2 - Partial Matches =====")
//
//

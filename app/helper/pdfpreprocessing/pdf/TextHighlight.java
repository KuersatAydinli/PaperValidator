...
/**
 * This class implements the methods highlight and highlightDefault which will add a highlight to
 * the PDF based on a Pattern or String. The idea is to extend the PDFTextStripper and override the
 * methods that write to the Output to instead write to a TextCache that keeps data on the position
 * of the TextPositions. From this information we can then derive bounding boxes (and quads) that
 * can be used to write the annotations. See the main method for example usage
 *
...
public class TextHighlight extends PDFTextStripper {
    ...
    /**
     * Instantiate a new object. This object will load properties from PDFTextAnnotator.properties
     * and will apply encoding-specific conversions to the output text.
     *
    ...
    /**
     * Computes a series of bounding boxes (PDRectangle) from a list of TextPositions. It will
    ...
    /**
     * The height modifier is applied to the font height, it allows the annotations to be changed by
     * a certain factor
     */
    ...
    /**
     * Write a string to the text cache. The default implementation will ignore the
     ...
     * This is needed to compute bounding boxes. The data is stored on a per-page basis (keyed on
     * the 1-based pageNo)
     */
    public class TextCache {
        ...
        /**
         * Given a page and a pattern it will return a list of matches for that pattern. A Match is
         * a tuple of <String, List<TextPositions>>
         *
